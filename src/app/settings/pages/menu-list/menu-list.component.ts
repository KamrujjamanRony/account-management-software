  ...
  onSubmit(e: Event) {
    ...
    if (this.form.valid) {
      ...
      if (this.selectedMenu) {
        this.menuService.update(this.selectedMenu.id, { ...this.form.value, parentMenuId: this.form.value.parentMenuId || null, permissionsKey: this.form.value.permissionsKey || [] })
          .subscribe({
            next: (response) => {
        ...
        this.menuService.add({ ...this.form.value, parentMenuId: this.form.value.parentMenuId || null, permissionsKey: this.form.value.permissionsKey || [] })
          .subscribe({
            next: (response) => {
              if (response !== null && response !== undefined) {
