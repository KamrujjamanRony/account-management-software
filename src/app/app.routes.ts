...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: 'outdoor',
                loadComponent: () => import('./layouts/outdoor/outdoor.component').then(m => m.OutdoorComponent),
                children: [
            ...
            {
                path: 'doctor-fee',
                loadComponent: () => import('./layouts/doctor-fee-layout/doctor-fee-layout.component').then(m => m.DoctorFeeLayoutComponent),
                children: [
                    { path: '', redirectTo: '', pathMatch: 'full' },
                    {
                        path: '',
            ...
            {
                path: 'settings',
                loadComponent: () => import('./layouts/settings-layout/settings-layout.component').then(m => m.SettingsLayoutComponent),
                children: [
